export default function Hero () {
  return (
    <div className="relative text-white h-screen overflow-hidden">
      ...
      <div className="absolute z-10 left-0 top-0 w-2/5 h-full px-4 sm:px-6 lg:px-32 flex flex-col justify-center bg-black">
        ...
        <a 
          ...
          className="text-white px-4 py-2 border-2 hover:bg-red-700 hover:border-red-700 text-center inline-block w-auto" 
          target="_blank" 
