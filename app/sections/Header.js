      ...
      <div className="container mx-auto flex items-center justify-between py-5 px-6">
        ...
        <nav>
          <ul className="flex items-center space-x-4">
            ...
            <li>
              {/* Buy Tickets Button */}
              <a href="https://open.spotify.com/show/7Hg8aL7xyELS2CJ9TKYykC?si=eb671e91da174363" className="text-sm xs:text-base bg-red md:bg-black md:border-2 md:border-black text-white px-6 py-2 hover:bg-red hover:border-red" target="_blank" rel="noopener noreferrer">LISTEN TO EPISODES</a>
            </li>
          </ul>
        </nav>
      </div>
